  ...
  return (
    <div className="fixed inset-0 z-[200] flex flex-col items-center justify-center bg-[#1A2B3D] overflow-hidden">
      ...
      <div className="relative flex flex-col items-center">
        ...
        <div className="mt-12 text-center space-y-3 relative">
           <div className="flex items-center justify-center gap-3">
              <h2 className="text-xl font-black text-white tracking-[0.2em] uppercase">RideVendor</h2>
              <div className="h-1 w-1 rounded-full bg-[#FDB813]" />
              <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Fleet OS</span>
           </div>
      ...
      <div className="absolute bottom-12 left-0 right-0 text-center">
         <p className="text-[8px] font-black text-slate-700 uppercase tracking-[0.5em]">Seamless Mobility. Ultimate Freedom.</p>
      </div>
