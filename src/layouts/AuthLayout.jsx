    ...
    <div className="min-h-screen flex flex-col md:flex-row bg-white">
        ...
        <div className="relative z-10 w-full h-full p-12 flex flex-col justify-between">
          ...
          <div className="space-y-4 max-w-md">
            <h1 className="text-5xl font-black text-white leading-tight tracking-tighter">
              {isLogin ? "Welcome back to the elite journey." : "Start your premier acquisition journey."}
            </h1>
      ...
      <div className="flex-1 flex flex-col min-h-screen relative">
        <div className="absolute top-8 right-8 z-10">
          <Link to="/" className="text-slate-400 font-bold hover:text-slate-900 transition-colors text-sm">
            Back to Home
          </Link>
        </div>
        ...
        {/* Footer Links */}
        <div className="p-8 flex items-center justify-between border-t border-slate-50 text-[10px] font-black uppercase tracking-widest text-slate-400">
