  ...
  return (
    <div className="space-y-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <button 
          className="px-6 py-3 rounded-xl bg-accent text-primary text-[10px] font-black uppercase tracking-widest hover:bg-accent/90 transition-all shadow-md"
        >
          Add New Listing
        </button>
      </div>
      ...
      <div className="flex flex-col items-center justify-center p-16 text-center space-y-4 bg-white rounded-[2.5rem] border border-slate-100 shadow-sm">
        ...
        <h3 className="text-xl font-black text-slate-900 tracking-tight">No Active Listings</h3>
