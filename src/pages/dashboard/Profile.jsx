    ...
    <div className="flex-1">
      ...
      {isEditing && onChange ? (
        <input 
          ...
          className="w-full bg-transparent text-base font-black text-[#1A2B3D] tracking-tight outline-none border-b-2 border-slate-100 focus:border-[#FDB813] placeholder:font-medium placeholder:text-slate-300 pb-1.5 transition-colors"
        />
      ) : (
        <p className="text-base font-black text-[#1A2B3D] tracking-tight transition-all group-hover:translate-x-1 duration-500">{value || 'Not provided'}</p>
      )}
    </div>
         ...
         <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-10">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 backdrop-blur-md">
                 ...
                 <span className="text-[9px] font-black uppercase tracking-widest text-white/70">Verified Account</span>
              </div>
              <h1 className="text-5xl font-black tracking-tighter leading-none">Account Command Center</h1>
            ...
            <div className="flex items-center gap-4">
               {isEditing && (
                 <button 
                   ...
                   disabled={isPending}
                   className="px-8 py-4 rounded-2xl text-[11px] font-black uppercase tracking-widest border border-white/10 hover:bg-white/5 transition-all"
                 >
                   Discard
                 </button>
               )}
               <button 
                 ...
                 disabled={isPending}
                 className="px-10 py-4 rounded-2xl bg-[#FDB813] text-[#1A2B3D] text-[11px] font-black uppercase tracking-widest shadow-2xl shadow-[#FDB813]/20 hover:scale-105 active:scale-95 transition-all flex items-center gap-3"
               >
                 {isPending ? (
        ...
        <div className="lg:col-span-4 space-y-8">
           <div className="bg-white rounded-[3.5rem] border border-slate-100 p-12 flex flex-col items-center text-center shadow-sm relative group">
              <div className="relative mb-8">
                 <div className="h-40 w-40 rounded-[3rem] bg-[#1A2B3D] border-[8px] border-slate-50 flex items-center justify-center font-black text-6xl text-white relative overflow-hidden group-hover:rotate-3 transition-transform duration-700">
              ...
              <div className="space-y-2 mb-10">
                 <h3 className="text-3xl font-black text-[#1A2B3D] tracking-tighter">{user?.name}</h3>
                 <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.3em]">{user?.email}</p>
              </div>
              ...
              <div className="w-full pt-8 border-t border-slate-50 space-y-4">
                 <div className="flex items-center justify-between p-5 rounded-3xl bg-slate-50">
                    <span className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Protocol</span>
                    <span className="text-[10px] font-black uppercase text-[#1A2B3D] tracking-widest">{user?.role || 'User'}</span>
                 </div>
                 <div className="flex items-center justify-between p-5 rounded-3xl bg-slate-50">
                    <span className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Access Key</span>
           ...
           <div className="bg-[#1A2B3D] rounded-[3rem] p-10 text-white relative overflow-hidden group">
              ...
              <div className="relative z-10 space-y-8">
                 ...
                 <div className="space-y-4">
                   <h3 className="text-xl font-black uppercase tracking-widest">Fleet Security</h3>
                 ...
                 <button className="w-full py-5 rounded-2xl bg-white/5 hover:bg-white/10 border border-white/5 text-[11px] font-black uppercase tracking-widest text-[#FDB813] transition-all">
        ...
        <div className="lg:col-span-8 space-y-12">
           <div className="space-y-6">
              <div className="flex items-center gap-4 px-2">
                 ...
                 <h3 className="text-xl font-black text-[#1A2B3D] tracking-tight">Personal Identity</h3>
              </div>
           ...
           <div className="space-y-6">
              <div className="flex items-center gap-4 px-2">
                 ...
                 <h3 className="text-xl font-black text-[#1A2B3D] tracking-tight">Contact Access</h3>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 <InfoSection 
                   label="Primary Email" 
           ...
           <div className="pt-10 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-8 py-10 px-6">
              <div className="space-y-3">
                 <div className="flex items-center gap-3">
                    ...
                    <p className="font-black text-[#1A2B3D] text-lg tracking-tight">Account Deactivation</p>
                 </div>
              ...
              <button className="w-full sm:w-auto px-10 py-5 rounded-2xl bg-red-50 text-red-600 border-2 border-red-100 text-[11px] font-black uppercase tracking-widest hover:bg-red-600 hover:text-white hover:border-red-600 transition-all shadow-xl shadow-red-500/5">
                 Request Termination
              </button>
           </div>
        </div>
