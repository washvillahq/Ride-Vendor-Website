    ...
    <div className="space-y-10">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        <div className="space-y-2">
          <h1 className="text-4xl font-medium text-slate-900 tracking-tighter">Saved Vehicles</h1>
      ...
      <div className="flex flex-col items-center justify-center p-16 text-center space-y-4 bg-white rounded-[2.5rem] border border-slate-100 shadow-sm">
        ...
        <h3 className="text-xl font-medium text-slate-900 tracking-tight">No Saved Vehicles</h3>
        ...
        <button
          ...
          className="mt-6 px-6 py-3 rounded-xl bg-slate-900 text-white text-[10px] font-medium uppercase tracking-widest hover:bg-accent hover:text-primary transition-all"
        >
          Explore Cars
        </button>
      </div>
