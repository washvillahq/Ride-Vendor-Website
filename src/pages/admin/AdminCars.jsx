  ...
  return (
    <div className="space-y-10 pb-20">
      <section className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-4xl font-medium text-slate-900 tracking-tight">Fleet Management</h1>
        ...
        <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
          <Table>
            <TableHeader className="bg-slate-50/50">
              <TableRow>
                <TableHead className="py-5 px-8 font-medium uppercase tracking-widest text-[10px]">Vehicle Identity</TableHead>
                <TableHead className="py-5 font-medium uppercase tracking-widest text-[10px]">Registry Type</TableHead>
                <TableHead className="py-5 font-medium uppercase tracking-widest text-[10px]">Valuation</TableHead>
                <TableHead className="py-5 font-medium uppercase tracking-widest text-[10px]">Coordinates</TableHead>
                <TableHead className="py-5 font-medium uppercase tracking-widest text-[10px]">Operational Status</TableHead>
                ...
                <TableRow key={car._id} className="group hover:bg-slate-50/50 transition-colors">
                  <TableCell className="py-6 px-8">
                    <div className="flex items-center gap-5">
                      ...
                      <div>
                        <p className="font-medium text-slate-900 leading-tight text-base">{car.title}</p>
                        <div className="flex items-center gap-2 mt-1.5">
                          <span className="text-[9px] font-medium text-blue-600 uppercase tracking-widest bg-blue-50 px-2 py-0.5 rounded-md">{car.brand}</span>
                          <span className="text-[9px] font-medium text-slate-400 uppercase tracking-widest">{car.category}</span>
                        </div>
                      </div>
                    </div>
                  </TableCell>
                  <TableCell className="py-6">
                    <Badge
                      ...
                      className={cn(
                        "uppercase font-medium text-[9px] tracking-widest px-3 py-1 rounded-lg",
                  ...
                  <TableCell className="py-6">
                    <div className="flex flex-col">
                      <span className="font-medium text-slate-900">₦{car.type === 'rental' ? car.pricePerDay?.toLocaleString() : car.salePrice?.toLocaleString()}</span>
                  ...
                  <TableCell className="py-6"><StatusBadge status={car.status} className="text-[9px] font-medium uppercase px-3" /></TableCell>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-12 pb-12">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-medium text-slate-900 tracking-tight">Core Vehicle Identity</h3>
          ...
          <div className="space-y-8 bg-slate-50/50 p-8 rounded-[2.5rem] border border-slate-100">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-medium text-slate-900 tracking-tight">Regional Operations</h3>
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-medium text-slate-900 tracking-tight">Technical DNA</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div className="flex flex-col gap-2 justify-end pb-1 px-1">
                <label className="text-[10px] font-medium uppercase tracking-widest text-slate-400">Environment Control</label>
                <div className="flex items-center gap-4 h-[60px] bg-slate-50 border border-slate-100 rounded-2xl px-6">
                  <input
                    ...
                    id="climate"
                  />
                  <label htmlFor="climate" className="text-sm font-medium text-slate-700 cursor-pointer">Climate Control Active</label>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-8 bg-[#1A2B3D] p-10 rounded-[3rem] border border-black shadow-2xl shadow-blue-900/10 text-white">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-xl font-medium text-white tracking-tight">Commercial Configuration</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              <div className="space-y-4">
                <label className="text-[10px] font-medium uppercase tracking-widest text-white/50">Market Strategy</label>
                <div className="grid grid-cols-2 gap-4">
                  {['rental', 'sale'].map((type) => (
                    <label
                      key={type}
                      className={cn(
                        "flex items-center justify-center py-5 px-6 rounded-2xl border-2 transition-all cursor-pointer font-medium text-xs uppercase tracking-widest",
                        carType === type
              ...
              <div className="space-y-4">
                <label className="text-[10px] font-medium uppercase tracking-widest text-white/50">Valuation Agreement (₦)</label>
                {carType === 'rental' ? (
                  <div className="relative">
                    <span className="absolute left-6 top-1/2 -translate-y-1/2 text-accent font-medium text-lg">₦</span>
                    <input
                      type="number"
                      {...register('pricePerDay')}
                      placeholder="Daily Hire Rate"
                      className="w-full bg-white/5 border border-white/10 rounded-2xl pl-12 pr-6 py-5 text-xl font-medium focus:ring-2 focus:ring-accent outline-none transition-all"
                    />
                    <span className="absolute right-6 top-1/2 -translate-y-1/2 text-[10px] font-medium text-white/30 uppercase tracking-widest">/ Day</span>
                  </div>
                ) : (
                  <div className="relative">
                    <span className="absolute left-6 top-1/2 -translate-y-1/2 text-accent font-medium text-lg">₦</span>
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/10 rounded-2xl pl-12 pr-6 py-5 text-xl font-medium focus:ring-2 focus:ring-accent outline-none transition-all"
                    />
                    <span className="absolute right-6 top-1/2 -translate-y-1/2 text-[10px] font-medium text-white/30 uppercase tracking-widest">Final</span>
                  </div>
                )}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12">
            <div className="md:col-span-12 space-y-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-medium text-slate-900 tracking-tight">Intelligence & Narrative</h3>
            ...
            <div className="md:col-span-12 space-y-8">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-medium text-slate-900 tracking-tight">Visual Documentation</h3>
              ...
              <div className="group relative flex flex-col items-center justify-center p-12 bg-white border-4 border-dashed border-slate-100 rounded-[3rem] hover:border-accent hover:bg-slate-50/50 transition-all duration-500 text-center">
                ...
                <div className="space-y-1">
                  <h4 className="text-lg font-medium text-slate-900">Deploy Assets</h4>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-end gap-6 pt-12 border-t border-slate-100">
            <button
              ...
              className="text-[10px] font-medium uppercase tracking-[0.3em] text-slate-400 hover:text-black transition-colors"
            ...
            <Button
              ...
              className="w-full sm:w-auto px-16 py-8 rounded-[2rem] shadow-2xl shadow-primary/20 text-sm font-medium uppercase tracking-[0.2em]"
            >
