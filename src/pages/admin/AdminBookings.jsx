  ...
  return (
    <div className="space-y-10 pb-20">
      <section className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
           <h1 className="text-4xl font-black text-primary tracking-tight">Booking Oversight</h1>
              ...
              <TableRow key={booking._id} className="group hover:bg-gray-50/50 transition-colors">
                <TableCell className="py-6 px-8">
                   <div className="flex items-center gap-4">
                      ...
                      <div>
                         <p className="font-black text-primary leading-none">{booking.user?.name || 'Guest Participant'}</p>
                ...
                <TableCell className="py-6 font-black text-primary text-xs">
                ...
                <TableCell className="py-6 font-black text-primary text-base">
