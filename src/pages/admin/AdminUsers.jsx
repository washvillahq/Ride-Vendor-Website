  ...
  return (
    <div className="space-y-10 pb-20">
      <section className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-4xl font-medium text-slate-900 tracking-tight">User Identification</h1>
        ...
        <div className="flex items-center gap-3 bg-slate-100/50 px-6 py-3 rounded-2xl border border-slate-100">
          ...
          <p className="text-sm font-medium text-slate-900 tracking-tight">{users.length} Total Registered</p>
        </div>
      </section>
        ...
        <div className="bg-white rounded-[2.5rem] border border-slate-100 shadow-sm overflow-hidden">
          <Table>
            <TableHeader className="bg-slate-50/50">
              <TableRow>
                <TableHead className="py-5 px-8 font-medium uppercase tracking-widest text-[10px]">Registry Identity</TableHead>
                <TableHead className="py-5 font-medium uppercase tracking-widest text-[10px]">Communication</TableHead>
                <TableHead className="py-5 font-medium uppercase tracking-widest text-[10px]">Authority</TableHead>
                  ...
                  <TableCell className="py-6 px-8">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] font-medium text-blue-500 mt-1.5 uppercase tracking-widest leading-none bg-blue-50 px-2 py-0.5 rounded-md inline-block">ID: {user._id.slice(-6)}</p>
                      </div>
                    </div>
                  </TableCell>
                  ...
                  <TableCell className="py-6 px-8 text-right">
                    {user.role !== 'admin' ? (
                      <Button
                        ...
                        size="sm"
                        className={cn(
                          "text-[10px] font-medium uppercase tracking-widest rounded-xl transition-all",
                      ...
                      <span className="text-[10px] font-medium text-slate-300 uppercase tracking-widest cursor-not-allowed">Admin Protected</span>
                    )}
                  </TableCell>
                </TableRow>
              ))}
