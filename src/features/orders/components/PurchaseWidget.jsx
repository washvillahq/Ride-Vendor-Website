  ...
  return (
    <Card className="sticky top-24 border-slate-200 shadow-xl overflow-hidden rounded-[2rem]">
      <CardContent className="p-8">
        <div className="mb-8">
          <p className="text-sm font-bold text-slate-500 uppercase tracking-widest mb-1">Selling Price</p>
        ...
        <div className="space-y-6">
          ...
          <Button 
            className="w-full h-16 text-xl font-black rounded-2xl bg-black hover:bg-black/90 shadow-lg"
            onClick={onPurchase}
